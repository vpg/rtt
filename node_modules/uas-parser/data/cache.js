module.exports = { version: '20140721-01',
  robots: 
   { '3': 
      ...
      { userAgent: 'Googlebot-Image/1.0',
        metadata: 
         { uaFamily: 'Googlebot',
           ...
           uaUrl: 'https://support.google.com/webmasters/answer/1061943?hl=en',
      ...
      { userAgent: 'psbot/0.1 (+http://www.picsearch.com/bot.html)',
        metadata: 
         { uaFamily: 'psbot',
           ...
           uaCompany: 'Picsearch Services AB',
      ...
      { userAgent: 'Mozilla/4.0 (compatible; MSIE 5.0; Windows 95) VoilaBot BETA 1.2 (http://www.voila.com/)',
        metadata: 
         { uaFamily: 'VoilaBot',
           ...
           uaUrl: '',
           uaCompany: 'Orange SA',
           uaCompanyUrl: 'http://www.orange.fr/',
           uaIcon: 'bot.png',
      ...
      { userAgent: 'Mozilla/4.0 (compatible; MSIE is not me; DAUMOA/1.0.0; DAUM Web Robot; Daum Communications Corp., Korea)',
        metadata: 
         { uaFamily: 'Daumoa',
           ...
           uaCompany: 'Daum Communications Corp.',
           uaCompanyUrl: 'http://www.daumcorp.com/',
           uaIcon: 'bot_Daumoa.png',
     ...
     '679': 
      { userAgent: 'Mozilla/5.0 (compatible; Exabot/3.0; +http://www.exabot.com/go/robot)',
        metadata: 
         { uaFamily: 'Exabot',
           uaName: 'Exabot/3.0',
           uaUrl: 'http://www.exalead.com/search/webmasterguide',
           uaCompany: 'Dassault Systèmes',
           uaCompanyUrl: 'http://www.3ds.com/',
     ...
     '1238': 
      { userAgent: 'CCBot/1.0 (+http://www.commoncrawl.org/bot.html)',
        metadata: 
         { uaFamily: 'CCBot',
           uaName: 'CCBot/1.0',
           uaUrl: 'http://commoncrawl.org/faq/',
     ...
     '1459': 
      { userAgent: 'Mozilla/5.0 (compatible; DotBot/1.1; http://www.dotnetdotcom.org/, crawler@dotnetdotcom.org)',
        metadata: 
         { uaFamily: 'DotBot',
           uaName: 'DotBot/1.1',
           uaUrl: 'http://www.opensiteexplorer.org/dotbot',
      ...
      { userAgent: 'Mozilla/5.0 (compatible; Seznam screenshot-generator 2.0; +http://fulltext.sblog.cz/screenshot/)',
        metadata: 
         { uaFamily: 'SeznamBot',
           ...
           uaUrl: 'http://www.mapy.cz/cz/seznambot.html',
     ...
     '1475': 
      { userAgent: 'linkdexbot/Nutch-1.0-dev (http://www.linkdex.com/; crawl at linkdex dot com)',
        metadata: 
         { uaFamily: 'linkdexbot',
           uaName: 'linkdexbot',
           uaUrl: 'http://www.linkdex.com/bots/',
      ...
      { userAgent: 'CatchBot/1.0; +http://www.catchbot.com',
        metadata: 
         { uaFamily: 'CatchBot',
           ...
           uaCompany: 'Cirrus Media Pty Ltd',
           uaCompanyUrl: 'http://www.cirrusmedia.com.au/',
      ...
      { userAgent: 'Mozilla/5.0 (compatible; 80bot/0.71; http://www.80legs.com/spider.html;) Gecko/2008032620',
        metadata: 
         { uaFamily: '008',
           ...
           uaCompany: 'Datafiniti, LLC.',
           uaCompanyUrl: 'http://datafiniti.net/',
           uaIcon: 'bot_80legs.png',
           uaInfoUrl: '/list-of-ua/bot-detail?bot=008' } },
     '1637': 
     ...
     '2294': 
      { userAgent: 'Yahoo! Site Explorer Feed Validator http://help.yahoo.com/l/us/yahoo/search/siteexplorer/manage/',
        metadata: 
         { uaFamily: 'Yahoo!',
           uaName: 'Yahoo! Site Explorer Feed Validator',
           uaUrl: 'http://help.yahoo.com/',
           uaCompany: 'Yahoo! Inc',
           uaCompanyUrl: 'http://www.yahoo.com/',
           uaIcon: 'bot_yahoo!slurp.png',
     ...
     '3379': 
      { userAgent: 'Mozilla/5.0 (compatible; spbot/1.0; +http://www.seoprofiler.com/bot/ )',
        metadata: 
         { uaFamily: 'spbot',
           uaName: 'spbot/1.0',
           uaUrl: 'http://openlinkprofiler.org/bot',
      ...
      { userAgent: 'Mozilla/5.0 (compatible; spbot/2.0.3; +http://www.seoprofiler.com/bot/ )',
        metadata: 
         { uaFamily: 'spbot',
           ...
           uaInfoUrl: '/list-of-ua/bot-detail?bot=spbot' } },
     '4912': 
      { userAgent: 'AdsBot-Google-Mobile (+http://www.google.com/mobile/adsbot.html) Mozilla (iPhone; U; CPU iPhone OS 3 0 like Mac OS X) AppleWebKit (KHTML, like Gecko) Mobile Safari',
        metadata: 
         { uaFamily: 'Googlebot',
           uaName: 'AdsBot-Google-Mobile',
           uaUrl: 'https://support.google.com/webmasters/answer/1061943?hl=en',
           uaCompany: 'Google Inc.',
           uaCompanyUrl: 'http://www.google.com/',
           uaIcon: 'bot_googlebot.png',
      ...
      { userAgent: 'yacybot (x86 Windows XP 5.1; java 1.6.0_21; Europe/de) http://yacy.net/bot.html',
        metadata: 
         { uaFamily: 'yacybot',
           ...
           uaInfoUrl: '/list-of-ua/bot-detail?bot=yacybot' } },
     '5265': 
      { userAgent: 'Mozilla/4.0 (compatible;  Vagabondo/4.0; webcrawler at wise-guys dot nl; http://webagent.wise-guys.nl/)',
        metadata: 
         { uaFamily: 'Vagabondo',
      ...
      { userAgent: 'MetaGeneratorCrawler/1.1 (www.metagenerator.info)',
        metadata: 
         { uaFamily: 'MetaGeneratorCrawler',
           ...
           uaUrl: 'http://www.metagenerator.info/Crawler.html',
     ...
     '6286': 
      { userAgent: 'Mozilla/5.0 (compatible; MSIE or Firefox mutant; not on Windows server; +http://ws.daum.net/aboutWebSearch.html) Daumoa/3.0',
        metadata: 
         { uaFamily: 'Daumoa',
           uaName: 'Daumoa/3.0',
           uaUrl: 'http://tab.search.daum.net/aboutWebSearch_en.html',
      ...
      { userAgent: 'Mozilla/5.0 (compatible; SpiderLing (a SPIDER for LINGustic research); http://nlp.fi.muni.cz/projects/biwec/)',
        metadata: 
         { uaFamily: 'SpiderLing',
           ...
           uaCompanyUrl: 'http://nlp.fi.muni.cz/en/',
           uaIcon: 'bot.png',
           uaInfoUrl: '/list-of-ua/bot-detail?bot=SpiderLing' } },
     '6822': 
      { userAgent: 'Mozilla/5.0 (iPhone; CPU iPhone OS 5_0_1 like Mac OS X) (compatible; Yeti-Mobile/0.1; +http://help.naver.com/robots/)',
        metadata: 
         { uaFamily: 'NaverBot',
           uaName: ' Yeti-Mobile/0.1',
           uaUrl: 'http://help.naver.com/robots/',
           uaCompany: '',
           uaCompanyUrl: 'http://www.nhncorp.com/',
           uaIcon: 'bot_NaverBot.png',
     ...
     '7153': 
      { userAgent: 'percbotspider <ops@percolate.com>',
        metadata: 
         { uaFamily: 'PercolateCrawler',
           uaName: 'percbotspider',
           uaUrl: '',
           uaCompany: 'Percolate Industries, Inc.',
           uaCompanyUrl: 'http://www.percolate.com/',
           uaIcon: 'bot.png',
           uaInfoUrl: '/list-of-ua/bot-detail?bot=PercolateCrawler' } },
     '7155': 
     ...
     '7220': 
      { userAgent: 'Mozilla/5.0 (Windows; U; Windows NT 5.1;fr;rv:1.8.1) VoilaBotCollector BETA 0.1  (http://www.voila.com/)',
        metadata: 
         { uaFamily: 'VoilaBot',
           uaName: 'VoilaBotCollector BETA 0.1',
           uaUrl: '',
           uaCompany: 'Orange SA',
           uaCompanyUrl: 'http://www.orange.fr/',
           uaIcon: 'bot.png',
      ...
      { userAgent: 'WeSEE:Search/0.1 (Alpha, http://www.wesee.com/en/support/bot/)',
        metadata: 
         { uaFamily: 'WeSEE',
           ...
           uaUrl: 'http://www.wesee.com/bot/',
           uaCompany: 'WeSEE Ltd',
           uaCompanyUrl: 'http://www.wesee.com/',
           uaIcon: 'bot.png',
           uaInfoUrl: '/list-of-ua/bot-detail?bot=WeSEE' } },
     '7442': 
     ...
     '7503': 
      { userAgent: 'FeedlyBot/1.0 (http://feedly.com)',
        metadata: 
         { uaFamily: 'Feedly',
           uaName: 'FeedlyBot/1.0',
           uaUrl: 'http://www.feedly.com/fetcher.html',
           uaCompany: 'DevHD',
           uaCompanyUrl: 'http://www.feedly.com/',
           uaIcon: 'bot_feedly.png',
           uaInfoUrl: '/list-of-ua/bot-detail?bot=Feedly' } },
     '7510': 
     ...
     '7701': 
      { userAgent: 'Mozilla/5.0 (Windows; U; Windows NT 5.1; zh-CN; rv:1.8.0.11) Gecko/20070312 Firefox/1.5.0.11; 360Spider',
        metadata: 
         { uaFamily: '360Spider',
           uaName: '360Spider',
           uaUrl: 'http://www.so.com/help/help_3_2.html',
           uaCompany: '360.CN',
           uaCompanyUrl: 'http://360.cn/',
           uaIcon: 'bot.png',
           uaInfoUrl: '/list-of-ua/bot-detail?bot=360Spider' } },
     '7717': 
     ...
     '8068': 
      { userAgent: 'PercolateCrawler/3.1.30 (ops@percolate.com)',
        metadata: 
         { uaFamily: 'PercolateCrawler',
           uaName: 'PercolateCrawler/3.1.30',
           uaUrl: '',
           uaCompany: 'Percolate Industries, Inc.',
           uaCompanyUrl: 'http://www.percolate.com/',
           uaIcon: 'bot.png',
      ...
      { userAgent: 'Mozilla/5.0 (compatible; Kraken/0.1; http://linkfluence.net/; bot@linkfluence.net)',
        metadata: 
         { uaFamily: 'Kraken',
           uaName: 'Kraken/0.1',
           uaUrl: '',
           uaCompany: 'Linkfluence SAS',
           uaCompanyUrl: 'http://linkfluence.com/',
           uaIcon: 'bot.png',
           uaInfoUrl: '/list-of-ua/bot-detail?bot=Kraken' } },
     '8247': 
      { userAgent: 'Mozilla/5.0 (compatible; Mail.RU_Bot/2.0; +http://go.mail.ru/help/robots)',
        metadata: 
         { uaFamily: 'Mail.Ru bot',
           ...
           uaInfoUrl: '/list-of-ua/bot-detail?bot=Mail.Ru bot' } },
     '8275': 
      { userAgent: 'Yeti/1.1 (NHN Corp.; http://help.naver.com/robots/)',
        metadata: 
         { uaFamily: 'NaverBot',
           uaName: 'Yeti/1.1',
           uaUrl: 'http://help.naver.com/robots/',
     ...
     '9139': 
      { userAgent: 'NalezenCzBot/1.0 (http://www.nalezen.cz)',
        metadata: 
         { uaFamily: 'NalezenCzBot',
           uaName: 'NalezenCzBot/1.0',
           uaUrl: 'http://www.nalezen.cz/about-crawler',
           uaCompany: 'Jaroslav Kuboš',
           uaCompanyUrl: 'http://kubos.cz/',
           uaIcon: 'bot.png',
           uaInfoUrl: '/list-of-ua/bot-detail?bot=NalezenCzBot' } },
     '9165': 
     ...
     '10923': 
      { userAgent: 'Cliqz Bot (+http://www.cliqz.com)',
        metadata: 
         { uaFamily: 'CliqzBot',
           uaName: 'Cliqz Bot',
           uaUrl: 'Cliqzbot/0.1 (+http://cliqz.com/company/cliqzbot)',
     ...
     '11239': 
      { userAgent: 'Mozilla/5.0 (compatible; EasouSpider; +http://www.easou.com/search/spider.html)',
        metadata: 
         { uaFamily: 'EasouSpider',
           uaName: 'EasouSpider',
           uaUrl: 'http://www.easou.com/search/spider.html',
           uaCompany: 'easou.com',
           uaCompanyUrl: 'http://www.easou.com/',
           uaIcon: 'bot.png',
           uaInfoUrl: '/list-of-ua/bot-detail?bot=EasouSpider' } },
     '11253': 
      ...
      { userAgent: 'Mozilla/5.0 (compatible; spbot/4.0; +http://www.seoprofiler.com/bot )',
        metadata: 
         { uaFamily: 'spbot',
           ...
           uaInfoUrl: '/list-of-ua/bot-detail?bot=spbot' } },
     '11445': 
      { userAgent: 'Mozilla/5.0 (compatible; Linux x86_64; Mail.RU_Bot/Img/2.0; +http://go.mail.ru/help/robots)',
        metadata: 
         { uaFamily: 'Mail.Ru bot',
           uaName: 'Mail.RU_Bot/Img/2.0',
           uaUrl: 'http://go.mail.ru/help/robots',
           uaCompany: 'Mail.Ru Group',
           uaCompanyUrl: 'http://corp.mail.ru/',
           uaIcon: 'bot.png',
      ...
      { userAgent: 'DoCoMo/2.0 N905i(c100;TB;W24H16) (compatible; Googlebot-Mobile/2.1; +http://www.google.com/bot.html)',
        metadata: 
         { uaFamily: 'Googlebot',
           ...
           uaInfoUrl: '/list-of-ua/bot-detail?bot=Googlebot' } },
     '11465': 
      { userAgent: 'Curious George - www.analyticsseo.com/crawler',
        metadata: 
         { uaFamily: 'Curious George',
           uaName: 'Curious George',
           uaUrl: 'http://www.analyticsseo.com/crawler',
           uaCompany: 'Analytics SEO Limited',
           uaCompanyUrl: 'http://www.analyticsseo.com/',
           uaIcon: 'bot.png',
           uaInfoUrl: '/list-of-ua/bot-detail?bot=Curious George' } },
     '11467': 
      { userAgent: 'socialbm_bot http://spider.socialbm.net',
        metadata: 
         { uaFamily: 'socialbm_bot',
           uaName: 'socialbm_bot',
           uaUrl: 'http://spider.socialbm.net',
           ...
           uaInfoUrl: '/list-of-ua/bot-detail?bot=socialbm_bot' } },
     '11480': 
      { userAgent: 'Mozilla/5.0 (compatible; LuminateBot/1.0; +http://www.luminate.com/bot/)',
        metadata: 
         { uaFamily: 'LuminateBot',
           uaName: 'LuminateBot/1.0',
           uaUrl: 'http://www.luminate.com/bot/',
           uaCompany: 'Luminate, Inc.',
           uaCompanyUrl: 'http://www.luminate.com/',
           uaIcon: 'bot.png',
           uaInfoUrl: '/list-of-ua/bot-detail?bot=LuminateBot' } },
     '11483': 
      { userAgent: 'msnbot-media/2.0b (+http://search.msn.com/msnbot.htm)',
        metadata: 
         { uaFamily: 'MSNBot',
           uaName: 'msnbot-media/2.0b',
           uaUrl: 'http://search.msn.com/msnbot.htm',
           uaCompany: 'Microsoft Corporation',
           uaCompanyUrl: 'http://www.microsoft.com/',
           uaIcon: 'bot_msnbot.png',
           uaInfoUrl: '/list-of-ua/bot-detail?bot=MSNBot' } },
     '11484': 
      { userAgent: 'yacybot (freeworld-global; amd64 Windows 7 6.1; java 1.7.0_02-ea; America/en) http://yacy.net/bot.html',
        metadata: 
         { uaFamily: 'yacybot',
           uaName: 'yacybot',
           uaUrl: 'http://yacy.net/bot.html',
     ...
     '11506': 
      { userAgent: 'Mozilla/5.0 (compatible; BegunAdvertising/3.0; +http://begun.ru/begun/technology/indexer/)',
        metadata: 
         { uaFamily: 'BegunAdvertising',
           uaName: 'BegunAdvertising/3.0',
           uaUrl: 'http://begun.ru/begun/technology/indexer/',
           uaCompany: 'Begun',
           uaCompanyUrl: 'http://begun.ru/',
           uaIcon: 'bot.png',
           uaInfoUrl: '/list-of-ua/bot-detail?bot=BegunAdvertising' } },
     '11558': 
      { userAgent: 'Mozilla/5.0 (Windows; U; Windows NT 5.1; zh-CN; )  Firefox/1.5.0.11; 360Spider',
        metadata: 
         { uaFamily: '360Spider',
           ...
           uaInfoUrl: '/list-of-ua/bot-detail?bot=360Spider' } },
     '11562': 
      { userAgent: 'Mozilla/5.0 (compatible; Qualidator.com SiteAnalyzer 1.0;)',
        metadata: 
         { uaFamily: 'Qualidator.com SiteAnalyzer 1.0',
           uaName: 'Qualidator.com SiteAnalyzer 1.0',
           uaUrl: '',
           uaCompany: 'seven49.net GmbH',
           uaCompanyUrl: 'http://www.seven49.net/',
           uaIcon: 'bot.png',
           uaInfoUrl: '/list-of-ua/bot-detail?bot=Qualidator.com SiteAnalyzer 1.0' } },
     '11572': 
      { userAgent: 'Mozilla/5.0 (compatible; spbot/4.0.1; +http://www.seoprofiler.com/bot )',
        metadata: 
         { uaFamily: 'spbot',
           ...
           uaInfoUrl: '/list-of-ua/bot-detail?bot=spbot' } },
     '11573': 
      { userAgent: 'yacybot (freeworld/global; i386 Linux 3.2.0-23-generic; java 1.6.0_27; Europe/en) http://yacy.net/bot.html',
        metadata: 
         { uaFamily: 'yacybot',
           uaName: 'yacybot',
           uaUrl: 'http://yacy.net/bot.html',
      ...
      { userAgent: 'Cliqzbot/0.1 (+http://cliqz.com/company/cliqzbot)',
        metadata: 
         { uaFamily: 'Cliqzbot',
           ...
           uaInfoUrl: '/list-of-ua/bot-detail?bot=Cliqzbot' } },
     '11604': 
      { userAgent: 'yacybot (freeworld/global; amd64 Linux 3.2.0-4-amd64; java 1.7.0_25; Europe/de) http://yacy.net/bot.html',
        metadata: 
         { uaFamily: 'yacybot',
           uaName: 'yacybot',
           uaUrl: 'http://yacy.net/bot.html',
           ...
           uaInfoUrl: '/list-of-ua/bot-detail?bot=yacybot' } },
     '11615': 
      { userAgent: 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/535. Safari/535.22+; (+http://immediatenet.com/thumbnail_api.html; free thumbnails)',
        metadata: 
         { uaFamily: 'immediatenet thumbnails',
           uaName: 'immediatenet thumbnails',
           uaUrl: 'http://immediatenet.com/thumbnail_api.html',
           uaCompany: 'Offcode Ltd.',
           uaCompanyUrl: 'http://offcode.fi/',
           uaIcon: 'bot.png',
           uaInfoUrl: '/list-of-ua/bot-detail?bot=immediatenet thumbnails' } },
     '11665': 
      { userAgent: 'Mozilla/5.0 (compatible; URLAppendBot/1.0; +http://www.profound.net/urlappendbot.html)',
        metadata: 
         { uaFamily: 'URLAppendBot',
           uaName: 'URLAppendBot/1.0',
           uaUrl: 'http://www.profound.net/urlappendbot.html',
           uaCompany: 'Profound Networks, LLC',
           uaCompanyUrl: 'http://www.profound.net/',
           uaIcon: 'bot.png',
           uaInfoUrl: '/list-of-ua/bot-detail?bot=URLAppendBot' } },
     '11710': 
      { userAgent: 'Mozilla/5.0 (compatible; spbot/4.0.2; +http://www.seoprofiler.com/bot )',
        metadata: 
         { uaFamily: 'spbot',
           ...
           uaInfoUrl: '/list-of-ua/bot-detail?bot=spbot' } },
     '11721': 
      { userAgent: 'Mozilla/4.0 (CMS Crawler: http://www.cmscrawler.com)',
        metadata: 
         { uaFamily: 'CMS Crawler',
           uaName: 'CMS Crawler',
           uaUrl: 'http://www.cmscrawler.com/faq/',
           uaCompany: 'Viderem AB',
           uaCompanyUrl: 'http://viderem.se/',
           uaIcon: 'bot.png',
           uaInfoUrl: '/list-of-ua/bot-detail?bot=CMS Crawler' } },
     '11751': 
      { userAgent: 'Mozilla/5.0 (compatible; LoadTimeBot/0.7; +http://www.load-time.com/bot.html)',
        metadata: 
         { uaFamily: 'LoadTimeBot',
           uaName: 'LoadTimeBot/0.7',
           uaUrl: 'http://www.loadtime.net/bot.html',
           uaCompany: 'Loadtime',
           uaCompanyUrl: 'http://www.loadtime.net/',
           uaIcon: 'bot.png',
           uaInfoUrl: '/list-of-ua/bot-detail?bot=LoadTimeBot' } },
     '11778': 
      { userAgent: 'Mozilla/5.0 (Macintosh; U; Intel Mac OS X 10.6; en-US; rv:1.9.2) Gecko/20100115 Firefox/3.6 (FlipboardProxy/2.0; +http://flipboard.com/browserproxy)',
        metadata: 
         { uaFamily: 'FlipboardProxy',
           uaName: 'FlipboardProxy/2.0',
           uaUrl: 'http://flipboard.com/browserproxy',
           uaCompany: 'Flipboard, Inc.',
           uaCompanyUrl: 'http://flipboard.com/',
           uaIcon: 'bot_FlipboardProxy.png',
           uaInfoUrl: '/list-of-ua/bot-detail?bot=FlipboardProxy' } },
     '11782': 
      { userAgent: 'Mozilla/5.0 (compatible; IXEbot; +http://medialab.di.unipi.it/IXEbot.html)',
        metadata: 
         { uaFamily: 'IXEbot',
           uaName: 'IXEbot',
           uaUrl: 'http://medialab.di.unipi.it/IXEbot.html',
           uaCompany: 'Università di Pisa',
           uaCompanyUrl: 'http://www.unipi.it/',
           uaIcon: 'bot.png',
           uaInfoUrl: '/list-of-ua/bot-detail?bot=IXEbot' } },
     '11816': 
      { userAgent: 'BrainbruBot/1.0 (+http://www.brainbru.com/)',
        metadata: 
         { uaFamily: 'BrainbruBot',
           uaName: 'BrainbruBot/1.0',
           uaUrl: '',
           uaCompany: 'Brainbru.Com',
           uaCompanyUrl: 'http://www.brainbru.com/',
           uaIcon: 'bot.png',
           uaInfoUrl: '/list-of-ua/bot-detail?bot=BrainbruBot' } },
     '11823': 
      { userAgent: 'Mozilla/5.0 (compatible; kulturarw3 +http://www.kb.se/om/projekt/Svenska-webbsidor---Kulturarw3/)',
        metadata: 
         { uaFamily: 'kulturarw',
           uaName: 'kulturarw3',
           uaUrl: 'http://www.kb.se/om/projekt/Svenska-webbsidor---Kulturarw3/',
           uaCompany: 'National Library of Sweden',
           uaCompanyUrl: 'http://www.kb.se/',
           uaIcon: 'bot.png',
           uaInfoUrl: '/list-of-ua/bot-detail?bot=kulturarw' } },
     '11832': 
      ...
      { userAgent: 'Mozilla/5.0 (compatible; spbot/4.0.4; +http://www.seoprofiler.com/bot )',
        metadata: 
         { uaFamily: 'spbot',
           ...
           uaInfoUrl: '/list-of-ua/bot-detail?bot=spbot' } },
     '11940': 
      { userAgent: 'Mozilla/5.0 (compatible; Ezooms/1.0; help@moz.com)',
        metadata: 
         { uaFamily: 'Ezooms',
           uaName: 'Ezooms/1.0',
           uaUrl: '',
           ...
           uaInfoUrl: '/list-of-ua/bot-detail?bot=Ezooms' } },
     '11949': 
      { userAgent: 'Mozilla/5.0 (compatible; ExaleadCloudview/6;)',
        metadata: 
         { uaFamily: 'Exabot',
           uaName: 'ExaleadCloudview/6',
           uaUrl: 'http://www.exalead.com/search/webmasterguide',
           uaCompany: 'Dassault Systèmes',
           uaCompanyUrl: 'http://www.3ds.com/',
           uaIcon: 'bot_Exabot.png',
      ...
      { userAgent: 'adidxbot/2.0 (+http://search.msn.com/msnbot.htm)',
        metadata: 
         { uaFamily: 'MSNBot',
           ...
           uaInfoUrl: '/list-of-ua/bot-detail?bot=MSNBot' } },
     '11973': 
      { userAgent: 'MetaGeneratorCrawler/1.3.3 (www.metagenerator.info)',
        metadata: 
         { uaFamily: 'MetaGeneratorCrawler',
           uaName: 'MetaGeneratorCrawler/1.3.3',
           uaUrl: 'http://www.metagenerator.info/Crawler.html',
           uaCompany: 'Jan Bogutzki',
           uaCompanyUrl: 'http://jan.bogutzki.de/',
           uaIcon: 'bot.png',
           uaInfoUrl: '/list-of-ua/bot-detail?bot=MetaGeneratorCrawler' } },
     '11993': 
      { userAgent: 'omgilibot/0.4 +http://omgili.com',
        metadata: 
         { uaFamily: 'omgilibot',
           uaName: 'omgilibot/0.4',
           uaUrl: '',
           uaCompany: 'Buzzilla Ltd.',
           uaCompanyUrl: 'http://www.buzzilla.com/',
           uaIcon: 'bot.png',
           uaInfoUrl: '/list-of-ua/bot-detail?bot=omgilibot' } },
     '11994': 
      { userAgent: 'rogerbot/1.0 (http://www.seomoz.org/dp/rogerbot, rogerbot-wherecat@moz.com)',
        metadata: 
         { uaFamily: 'rogerbot',
           ...
           uaInfoUrl: '/list-of-ua/bot-detail?bot=rogerbot' } },
     '11999': 
      { userAgent: 'MetaGeneratorCrawler/1.3.14 (www.metagenerator.info)',
        metadata: 
         { uaFamily: 'MetaGeneratorCrawler',
           uaName: 'MetaGeneratorCrawler/1.3.14',
           uaUrl: 'http://www.metagenerator.info/Crawler.html',
           uaCompany: 'Jan Bogutzki',
           uaCompanyUrl: 'http://jan.bogutzki.de/',
           uaIcon: 'bot.png',
           uaInfoUrl: '/list-of-ua/bot-detail?bot=MetaGeneratorCrawler' } },
     '12015': 
      { userAgent: 'Jabse.com Crawler v.1.0 www.jabse.com/crawler.php//imagecrawler',
        metadata: 
         { uaFamily: 'Jabse.com Crawler',
           uaName: 'Jabse.com Crawler v.1.0',
           uaUrl: 'http://www.jabse.com/crawler.php',
           uaCompany: 'jabse',
           uaCompanyUrl: 'http://www.jabse.com/',
           uaIcon: 'bot.png',
           uaInfoUrl: '/list-of-ua/bot-detail?bot=Jabse.com Crawler' } },
     '12021': 
      { userAgent: 'Mozilla/5.0 (compatible; SEOkicks-Robot; +http://www.seokicks.de/robot.html)',
        metadata: 
         { uaFamily: 'SEOkicks-Robot',
           ...
           uaInfoUrl: '/list-of-ua/bot-detail?bot=SEOkicks-Robot' } },
     '12040': 
      { userAgent: 'Yeti/1.1 (Naver Corp.; http://help.naver.com/robots/)',
        metadata: 
         { uaFamily: 'NaverBot',
           uaName: 'Yeti/1.1',
           uaUrl: 'http://help.naver.com/robots/',
           ...
           uaInfoUrl: '/list-of-ua/bot-detail?bot=NaverBot' } },
     '12061': 
      { userAgent: 'CatchBot/5.0; +http://www.catchbot.com',
        metadata: 
         { uaFamily: 'CatchBot',
           uaName: 'CatchBot/5.0',
           uaUrl: 'http://www.catchbot.com/',
           ...
           uaInfoUrl: '/list-of-ua/bot-detail?bot=CatchBot' } },
     '12079': 
      { userAgent: 'Open Web Analytics Bot 1.5.4',
        metadata: 
         { uaFamily: 'Open Web Analytics Bot',
           uaName: 'Open Web Analytics Bot 1.5.4',
           uaUrl: 'http://www.openwebanalytics.com/',
           uaCompany: 'Peter Adams',
           uaCompanyUrl: 'http://www.oncefuture.com/padams/weblog/',
           uaIcon: 'bot.png',
           uaInfoUrl: '/list-of-ua/bot-detail?bot=Open Web Analytics Bot' } },
     '12088': 
      { userAgent: 'Readability/6a54d4 - http://readability.com/about/',
        metadata: 
         { uaFamily: 'Readability',
           uaName: 'Readability/6a54d4',
           uaUrl: '',
           uaCompany: 'Readability Team',
           uaCompanyUrl: 'http://readability.com/',
           uaIcon: 'bot.png',
           uaInfoUrl: '/list-of-ua/bot-detail?bot=Readability' } },
     '12090': 
      { userAgent: 'Mozilla/5.0 (compatible; Shareaholicbot/1.0; +http://www.shareaholic.com/bot)',
        metadata: 
         { uaFamily: 'Shareaholicbot',
           uaName: 'Shareaholicbot/1.0',
           uaUrl: 'http://www.shareaholic.com/bot',
           uaCompany: 'Shareaholic, Inc.',
           uaCompanyUrl: 'http://www.shareaholic.com/',
           uaIcon: 'bot.png',
           uaInfoUrl: '/list-of-ua/bot-detail?bot=Shareaholicbot' } },
     '12109': 
      { userAgent: 'ADmantX Platform Semantic Analyzer - ADmantX Inc. - www.admantx.com - support@admantx.com',
        metadata: 
         { uaFamily: 'ADmantX Platform Semantic Analyzer',
           uaName: 'ADmantX Platform Semantic Analyzer',
           uaUrl: '',
           uaCompany: 'ADmantX Inc.',
           uaCompanyUrl: 'http://www.admantx.com/',
           uaIcon: 'bot.png',
           uaInfoUrl: '/list-of-ua/bot-detail?bot=ADmantX Platform Semantic Analyzer' } },
     '12121': 
      { userAgent: 'crawler for netopian (http://www.netopian.co.uk/)',
        metadata: 
         { uaFamily: 'crawler for netopian',
           uaName: 'crawler for netopian',
           uaUrl: '',
           uaCompany: 'Netopian Ltd.',
           uaCompanyUrl: 'http://www.netopian.co.uk/',
           uaIcon: 'bot.png',
           uaInfoUrl: '/list-of-ua/bot-detail?bot=crawler for netopian' } },
     '12122': 
      { userAgent: 'Mozilla/5.0 (compatible; Seznam screenshot-generator 2.1; +http://fulltext.sblog.cz/screenshot/)',
        metadata: 
         { uaFamily: 'SeznamBot',
           uaName: 'Seznam screenshot-generator 2.1',
           uaUrl: 'http://www.mapy.cz/cz/seznambot.html',
           uaCompany: 'Seznam.cz, a.s.',
           uaCompanyUrl: 'http://www.seznam.cz/',
           uaIcon: 'seznam.png',
           uaInfoUrl: '/list-of-ua/bot-detail?bot=SeznamBot' } },
     '12123': 
      { userAgent: 'Mozilla/5.0 (Linux; U; Android 4.1.2; cs-cz; Seznam screenshot-generator Build/Q3) AppleWebKit/534.30 (KHTML, like Gecko) Version/4.0 Mobile Safari/534.30',
        metadata: 
         { uaFamily: 'SeznamBot',
           uaName: 'Seznam screenshot-generator Q3',
           uaUrl: 'http://www.mapy.cz/cz/seznambot.html',
           uaCompany: 'Seznam.cz, a.s.',
           uaCompanyUrl: 'http://www.seznam.cz/',
           uaIcon: 'seznam.png',
           uaInfoUrl: '/list-of-ua/bot-detail?bot=SeznamBot' } },
     '12137': 
      { userAgent: 'yacybot (freeworld/global; amd64 Linux 3.10.17-gentoo; java 1.7.0_45; UTC/en) http://yacy.net/bot.html',
        metadata: 
         { uaFamily: 'yacybot',
           uaName: 'yacybot',
           uaUrl: 'http://yacy.net/bot.html',
           ...
           uaInfoUrl: '/list-of-ua/bot-detail?bot=yacybot' } },
     '12159': 
      { userAgent: 'AntBot/1.0 (http://www.ant.com)',
        metadata: 
         { uaFamily: 'AntBot',
           uaName: 'AntBot/1.0',
           uaUrl: '',
      ...
      { userAgent: 'Mozilla/5.0 (compatible; spbot/4.0.5; +http://www.seoprofiler.com/bot )',
        metadata: 
         { uaFamily: 'spbot',
           ...
           uaInfoUrl: '/list-of-ua/bot-detail?bot=spbot' } },
     '12186': 
      { userAgent: 'Nekstbot - http://www.ipipan.waw.pl/nekst/nekstbot/',
        metadata: 
         { uaFamily: 'nekstbot',
           uaName: 'nekstbot',
           uaUrl: 'http://www.ipipan.waw.pl/nekst/nekstbot/',
           uaCompany: 'Instytut Podstaw Informatyki PAN',
           uaCompanyUrl: 'http://www.ipipan.waw.pl/',
           uaIcon: 'bot.png',
           uaInfoUrl: '/list-of-ua/bot-detail?bot=nekstbot' } },
     '12195': 
      { userAgent: 'WebCookies/1.0 (+http://webcookies.info/faq/#agent)',
        metadata: 
         { uaFamily: 'WebCookies',
           uaName: 'WebCookies/1.0',
           uaUrl: 'http://webcookies.info/faq/#agent',
           uaCompany: 'Paweł Krawczyk',
           uaCompanyUrl: 'https://plus.google.com/+Pawe%C5%82Krawczyk/posts',
           uaIcon: 'bot.png',
           uaInfoUrl: '/list-of-ua/bot-detail?bot=WebCookies' } },
     '12201': 
      { userAgent: 'AboutUsBot/Harpy (Website Analysis; http://www.aboutus.org/Aboutus:Bot; help@aboutus.org)',
        metadata: 
         { uaFamily: 'AboutUsBot',
           uaName: 'AboutUsBot/Harpy',
           uaUrl: 'http://www.aboutus.org/AboutUs:Bot',
           uaCompany: 'AboutUs, Inc.',
           uaCompanyUrl: 'http://www.aboutus.org/AboutUs.org',
           uaIcon: 'bot_AboutUsBot.png',
      ...
      { userAgent: 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko; Google Web Preview) Chrome/27.0.1453 Safari/537.36',
        metadata: 
         { uaFamily: 'Googlebot',
           ...
           uaInfoUrl: '/list-of-ua/bot-detail?bot=Googlebot' } },
     '12220': 
      { userAgent: 'yacybot (freeworld/global; amd64 Windows 7 6.1; java 1.7.0_45; Europe/de) http://yacy.net/bot.html',
        metadata: 
         { uaFamily: 'yacybot',
           uaName: 'yacybot',
           uaUrl: 'http://yacy.net/bot.html',
           ...
           uaInfoUrl: '/list-of-ua/bot-detail?bot=yacybot' } },
     '12221': 
      { userAgent: 'Mozilla/5.0 (compatible; ZB-1; +http://www.zeerch.com/bot.php)',
        metadata: 
         { uaFamily: 'ZeerchBot',
           uaName: 'ZeerchBot ZB-1',
           uaUrl: 'http://www.zeerch.com/bot.php',
           uaCompany: 'Zeerch Inc.',
           uaCompanyUrl: 'http://www.zeerch.com/',
           uaIcon: 'bot.png',
           uaInfoUrl: '/list-of-ua/bot-detail?bot=ZeerchBot' } },
     '12248': 
      { userAgent: 'LoadImpactPageAnalyzer/1.3.0 (Load Impact; http://loadimpact.com/)',
        metadata: 
         { uaFamily: 'LoadImpactPageAnalyzer',
           uaName: 'LoadImpactPageAnalyzer/1.3.0',
           uaUrl: '',
           uaCompany: 'Load Impact AB.',
           uaCompanyUrl: 'http://loadimpact.com/',
           uaIcon: 'bot.png',
           uaInfoUrl: '/list-of-ua/bot-detail?bot=LoadImpactPageAnalyzer' } },
     '12254': 
      { userAgent: 'Mozilla/5.0 (compatible; YYSpider; +http://www.yunyun.com/spider.html)',
        metadata: 
         { uaFamily: 'YYSpider',
           uaName: 'YYSpider',
           uaUrl: 'http://www.yunyun.com/spider.html',
           uaCompany: 'yunyun.com',
           uaCompanyUrl: 'http://www.yunyun.com/',
           uaIcon: 'bot.png',
           uaInfoUrl: '/list-of-ua/bot-detail?bot=YYSpider' } },
     '12267': 
      { userAgent: 'classbot (+http://allclasses.com)',
        metadata: 
         { uaFamily: 'classbot',
           uaName: 'classbot',
           uaUrl: '',
           uaCompany: 'Allclasses, Inc.',
           uaCompanyUrl: 'http://allclasses.com/',
           uaIcon: 'bot.png',
           uaInfoUrl: '/list-of-ua/bot-detail?bot=classbot' } },
     '12295': 
      { userAgent: 'Mozilla/5.0 (compatible; spbot/4.0.6; +http://www.seoprofiler.com/bot )',
        metadata: 
         { uaFamily: 'spbot',
           ...
           uaInfoUrl: '/list-of-ua/bot-detail?bot=spbot' } },
     '12324': 
      { userAgent: 'NalezenCzBot/1.0 (http://www.nalezen.cz/about-crawler)',
        metadata: 
         { uaFamily: 'NalezenCzBot',
           uaName: 'NalezenCzBot/1.0',
           uaUrl: 'http://www.nalezen.cz/about-crawler',
           ...
           uaInfoUrl: '/list-of-ua/bot-detail?bot=NalezenCzBot' } },
     '12329': 
      { userAgent: 'yacybot (freeworld/global; amd64 Windows Server 2012 6.2; java 1.7.0_25; Europe/de) http://yacy.net/bot.html',
        metadata: 
         { uaFamily: 'yacybot',
           uaName: 'yacybot',
           uaUrl: 'http://yacy.net/bot.html',
           ...
           uaInfoUrl: '/list-of-ua/bot-detail?bot=yacybot' } },
     '12340': 
      { userAgent: 'TurnitinBot/3.0 (http://www.turnitin.com/robot/crawlerinfo.html)',
        metadata: 
         { uaFamily: 'TurnitinBot',
           uaName: 'TurnitinBot/3.0',
           uaUrl: 'http://www.turnitin.com/robot/crawlerinfo.html',
           uaCompany: 'iParadigms, LLC.',
           uaCompanyUrl: 'http://www.iparadigms.com/',
           uaIcon: 'bot.png',
      ...
      { userAgent: 'WeSEE:Search',
        metadata: 
         { uaFamily: 'WeSEE',
           ...
           uaInfoUrl: '/list-of-ua/bot-detail?bot=WeSEE' } },
     '12391': 
      { userAgent: 'Mozilla/5.0 (X11; Linux i686) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/30.0.1599.101 Safari/537.36; SSL-Crawler: http://crawler.dcsec.uni-hannover.de',
        metadata: 
         { uaFamily: 'SSL-Crawler',
           uaName: 'SSL-Crawler',
           uaUrl: 'http://crawler.dcsec.uni-hannover.de/',
           uaCompany: 'Leibniz Universität Hannover',
           uaCompanyUrl: 'http://www.uni-hannover.de/',
           uaIcon: 'bot.png',
           uaInfoUrl: '/list-of-ua/bot-detail?bot=SSL-Crawler' } },
     '12398': 
      { userAgent: 'Mozilla/5.0 (compatible; SiteCondor; http://www.sitecondor.com)',
        metadata: 
         { uaFamily: 'SiteCondor',
           uaName: 'SiteCondor',
           uaUrl: '',
           uaCompany: 'Noctual, LLC',
           uaCompanyUrl: 'http://www.sitecondor.com/',
           uaIcon: 'bot.png',
           uaInfoUrl: '/list-of-ua/bot-detail?bot=SiteCondor' } },
     '12399': 
      { userAgent: 'Mozilla/5.0 (compatible; MojeekBot/0.6; http://www.mojeek.com/bot.html)',
        metadata: 
         { uaFamily: 'MojeekBot',
           uaName: 'MojeekBot/0.6',
           uaUrl: 'http://www.mojeek.com/bot.html',
           uaCompany: 'Mojeek Ltd.',
           uaCompanyUrl: 'http://www.mojeek.com/',
           uaIcon: 'bot_MojeekBot.png',
           uaInfoUrl: '/list-of-ua/bot-detail?bot=MojeekBot' } },
     '12411': 
      { userAgent: 'Mozilla/5.0 (Windows NT 6.1; Win64; x64) KomodiaBot/1.0',
        metadata: 
         { uaFamily: 'KomodiaBot',
           uaName: 'KomodiaBot/1.0',
           uaUrl: 'http://www.komodia.com/wiki/index.php?title=URL_server_crawler',
           uaCompany: 'Komodia Inc.',
           uaCompanyUrl: 'http://www.komodia.com/',
           uaIcon: 'bot.png',
           uaInfoUrl: '/list-of-ua/bot-detail?bot=KomodiaBot' } },
     '12424': 
      { userAgent: 'IdeelaborPlagiaat/1',
        metadata: 
         { uaFamily: 'IdeelaborPlagiaat',
           uaName: 'IdeelaborPlagiaat/1',
           uaUrl: '',
           uaCompany: 'Ideelabor',
           uaCompanyUrl: 'https://ideelabor.ee/',
           uaIcon: 'bot.png',
           uaInfoUrl: '/list-of-ua/bot-detail?bot=IdeelaborPlagiaat' } },
     '12434': 
      { userAgent: 'XRL/3.00 (Linux; i686; en-us) (+http://metamark.net/about)',
        metadata: 
         { uaFamily: 'XRL',
           uaName: 'XRL/3.00',
           uaUrl: 'http://metamark.net/about',
           uaCompany: 'Develooper LLC',
           uaCompanyUrl: 'http://develooper.com/',
           uaIcon: 'bot.png',
           uaInfoUrl: '/list-of-ua/bot-detail?bot=XRL' } },
     '12435': 
      { userAgent: 'Mozilla/5.0 (compatible; Linux x86_64; Mail.RU_Bot/Fast/2.0; +http://go.mail.ru/help/robots)',
        metadata: 
         { uaFamily: 'Mail.Ru bot',
           uaName: 'Mail.RU_Bot/Fast/2.0',
           uaUrl: 'http://go.mail.ru/help/robots',
           uaCompany: 'Mail.Ru Group',
           uaCompanyUrl: 'http://corp.mail.ru/',
           uaIcon: 'bot.png',
           uaInfoUrl: '/list-of-ua/bot-detail?bot=Mail.Ru bot' } },
     '12439': 
      { userAgent: 'Mozilla/5.0 (Windows NT 6.1; compatible; BDCbot/1.0; +http://ecommerce.bigdatacorp.com.br/faq.aspx) AppleWebKit/535.1 (KHTML, like Gecko) Chrome/13.0.782.107 Safari/535.1',
        metadata: 
         { uaFamily: 'BDCbot',
           uaName: 'BDCbot/1.0',
           uaUrl: 'http://ecommerce.bigdatacorp.com.br/faq.aspx',
           uaCompany: 'BigData Corp.',
           uaCompanyUrl: 'http://www.bigdatacorp.com.br/',
           uaIcon: 'bot.png',
           uaInfoUrl: '/list-of-ua/bot-detail?bot=BDCbot' } },
     '12447': 
      { userAgent: 'Mozilla/5.0 (compatible; heritrix/3.1.1 +http://places.tomtom.com/crawlerinfo)',
        metadata: 
         { uaFamily: 'TomTom places company search',
           uaName: 'TomTom places company search',
           uaUrl: 'http://places.tomtom.com/crawlerinfo',
           uaCompany: 'TomTom International BV.',
           uaCompanyUrl: 'http://www.tomtom.com/',
           uaIcon: 'bot.png',
           uaInfoUrl: '/list-of-ua/bot-detail?bot=TomTom places company search' } },
     '12448': 
      { userAgent: 'OoyyoBot (Used and new cars search engine;+http://www.ooyyo.com) ',
        metadata: 
         { uaFamily: 'OoyyoBot',
           uaName: 'OoyyoBot',
           uaUrl: '',
           uaCompany: 'OOYYO LLC.',
           uaCompanyUrl: 'http://www.ooyyonetwork.com/',
           uaIcon: 'bot.png',
           uaInfoUrl: '/list-of-ua/bot-detail?bot=OoyyoBot' } },
     '12471': 
      { userAgent: 'Mozilla/5.0 (compatible; Lipperhey SEO Service; http://www.lipperhey.com/)',
        metadata: 
         { uaFamily: 'Lipperhey Spider',
           uaName: 'Lipperhey Spider',
           uaUrl: 'http://www.lipperhey.com/en/website-spider/',
           uaCompany: 'Dataprovider B.V.',
           uaCompanyUrl: 'https://www.dataprovider.com/',
           uaIcon: 'bot.png',
           uaInfoUrl: '/list-of-ua/bot-detail?bot=Lipperhey Spider' } },
     '12508': 
      { userAgent: 'Mozilla/5.0 (compatible; LoadTimeBot/0.81; +http://www.load-time.com/bot.html)',
        metadata: 
         { uaFamily: 'LoadTimeBot',
           uaName: 'LoadTimeBot/0.81',
           uaUrl: 'http://www.loadtime.net/bot.html',
           uaCompany: 'Loadtime',
           uaCompanyUrl: 'http://www.loadtime.net/',
           uaIcon: 'bot.png',
           uaInfoUrl: '/list-of-ua/bot-detail?bot=LoadTimeBot' } },
     '12516': 
      { userAgent: 'Mozilla/5.0 (compatible; Web-Monitoring/1.0; +http://monoid.nic.ru/)',
        metadata: 
         { uaFamily: 'Web-Monitoring',
           uaName: 'Web-Monitoring/1.0',
           uaUrl: 'http://monoid.nic.ru/',
           uaCompany: 'RU-CENTER',
           uaCompanyUrl: 'http://www.nic.ru/',
           uaIcon: 'bot.png',
           uaInfoUrl: '/list-of-ua/bot-detail?bot=Web-Monitoring' } },
     '12531': 
      { userAgent: 'Linguee Bot (http://www.linguee.com/bot; bot@linguee.com)',
        metadata: 
         { uaFamily: 'Linguee Bot',
           ...
           uaInfoUrl: '/list-of-ua/bot-detail?bot=Linguee Bot' } },
     '12538': 
      { userAgent: 'Backlink-Ceck.de (+http://www.backlink-check.de/bot.html)',
        metadata: 
         { uaFamily: 'backlink-check.de',
           uaName: 'backlink-check.de',
           uaUrl: 'http://www.backlink-check.de/bot.html',
           uaCompany: 'Mediagreen Medienservice',
           uaCompanyUrl: 'http://mediagreen.de/',
           uaIcon: 'bot.png',
           uaInfoUrl: '/list-of-ua/bot-detail?bot=backlink-check.de' } },
     '12539': 
      { userAgent: 'Mozilla/5.0 (compatible; CloudFlare-AlwaysOnline/1.0; +http://www.cloudflare.com/always-online) AppleWebKit/534.34',
        metadata: 
         { uaFamily: 'CloudFlare-AlwaysOnline',
           uaName: 'CloudFlare-AlwaysOnline/1.0',
           uaUrl: 'http://www.cloudflare.com/always-online',
           uaCompany: 'CloudFlare, Inc.',
           uaCompanyUrl: 'http://www.cloudflare.com/',
           uaIcon: 'bot.png',
           uaInfoUrl: '/list-of-ua/bot-detail?bot=CloudFlare-AlwaysOnline' } },
     '12542': 
      { userAgent: 'LinkedInBot/1.0 (compatible; Mozilla/5.0; Jakarta Commons-HttpClient/3.1 +http://www.linkedin.com)',
        metadata: 
         { uaFamily: 'LinkedInBot',
           uaName: 'LinkedInBot/1.0',
           uaUrl: '',
           uaCompany: 'LinkedIn Inc.',
           uaCompanyUrl: 'http://www.linkedin.com/',
           uaIcon: 'bot_LinkedIn.png',
           uaInfoUrl: '/list-of-ua/bot-detail?bot=LinkedInBot' } },
     '12544': 
      { userAgent: 'linguatools-bot/Nutch-1.6 (searching for translated pages; http://www.linguatools.de/linguatoolsbot.html; peter dot kolb at linguatools dot org)',
        metadata: 
         { uaFamily: 'linguatools',
           uaName: 'linguatools',
           uaUrl: 'http://www.linguatools.de/linguatoolsbot.html',
           uaCompany: 'Peter Kolb & Prochazkova GbR',
           uaCompanyUrl: 'http://www.linguatools.de/',
           uaIcon: 'bot.png',
           uaInfoUrl: '/list-of-ua/bot-detail?bot=linguatools' } },
     '12564': 
      { userAgent: 'Mozilla/5.0 (compatible; Embedly/0.2; +http://support.embed.ly/)',
        metadata: 
         { uaFamily: 'Embedly',
           uaName: 'Embedly/0.2',
           uaUrl: '',
           uaCompany: 'Embed.ly, Inc.',
           uaCompanyUrl: 'http://embed.ly/',
           uaIcon: 'bot_Embedly.png',
           uaInfoUrl: '/list-of-ua/bot-detail?bot=Embedly' } },
     '12571': 
      { userAgent: 'Mozilla/5.0 (compatible; SeznamBot/3.2; +http://fulltext.sblog.cz/)',
        metadata: 
         { uaFamily: 'SeznamBot',
           uaName: 'SeznamBot/3.2',
           uaUrl: 'http://www.mapy.cz/cz/seznambot.html',
           uaCompany: 'Seznam.cz, a.s.',
           uaCompanyUrl: 'http://www.seznam.cz/',
           uaIcon: 'seznam.png',
           uaInfoUrl: '/list-of-ua/bot-detail?bot=SeznamBot' } },
     '12590': 
      { userAgent: 'Mozilla/5.0 (compatible; SeznamBot/3.2-test1; +http://fulltext.sblog.cz/)',
        metadata: 
         { uaFamily: 'SeznamBot',
           uaName: 'SeznamBot/3.2-test1',
           uaUrl: 'http://www.mapy.cz/cz/seznambot.html',
           uaCompany: 'Seznam.cz, a.s.',
           uaCompanyUrl: 'http://www.seznam.cz/',
           uaIcon: 'seznam.png',
           uaInfoUrl: '/list-of-ua/bot-detail?bot=SeznamBot' } },
     '12592': 
      { userAgent: 'ThumbSniper (http://thumbsniper.com)',
        metadata: 
         { uaFamily: 'ThumbSniper',
           uaName: 'ThumbSniper',
           uaUrl: 'http://thumbsniper.com/thumbsniper-considers-robots-txt/',
           uaCompany: 'Thomas Schulte',
           uaCompanyUrl: 'http://thumbsniper.com/',
           uaIcon: 'bot.png',
           uaInfoUrl: '/list-of-ua/bot-detail?bot=ThumbSniper' } },
     '12594': 
      { userAgent: 'Mozilla/5.0 (compatible; spbot/4.0.7; +http://OpenLinkProfiler.org/bot )',
        metadata: 
         { uaFamily: 'spbot',
           ...
           uaInfoUrl: '/list-of-ua/bot-detail?bot=spbot' } },
     '12620': 
      { userAgent: 'Mozilla/5.0 (compatible; WebThumbnail/2.2; Website Thumbnail Generator; +http://webthumbnail.org)',
        metadata: 
         { uaFamily: 'WebThumbnail',
           uaName: 'WebThumbnail/2.2',
           uaUrl: '',
           uaCompany: 'hellworx - Lukasz Cepowski',
           uaCompanyUrl: 'http://www.hellworx.com/',
           uaIcon: 'bot.png',
     ...
     '12621': 
      { userAgent: 'PayPal IPN ( https://www.paypal.com/ipn )',
        metadata: 
         { uaFamily: 'PayPal IPN',
           uaName: 'PayPal IPN',
           uaUrl: 'https://developer.paypal.com/docs/classic/ipn/integration-guide/IPNIntro/#protocol_and_arch',
           uaCompany: 'PayPal',
           uaCompanyUrl: 'http://www.paypal.com/',
           uaIcon: 'bot.png',
           uaInfoUrl: '/list-of-ua/bot-detail?bot=PayPal IPN' } },
     '12627': 
      { userAgent: 'WeSEE',
        metadata: 
         { uaFamily: 'WeSEE',
           ...
           uaInfoUrl: '/list-of-ua/bot-detail?bot=WeSEE' } },
     '12630': 
      { userAgent: 'hawkReader/1.8 (Link Parser; http://www.hawkreader.com/; Allow like Gecko) Build/f2b2566',
        metadata: 
         { uaFamily: 'hawkReader',
           uaName: 'hawkReader/1.8',
           uaUrl: '',
           uaCompany: 'Dominik Habichtsberg',
           uaCompanyUrl: 'http://www.hbg-it.de/',
           uaIcon: 'bot.png',
           uaInfoUrl: '/list-of-ua/bot-detail?bot=hawkReader' } },
     '12640': 
      { userAgent: 'yacybot (freeworld/global; amd64 Windows Server 2012 6.2; java 1.7.0_51; Europe/de) http://yacy.net/bot.html',
        metadata: 
         { uaFamily: 'yacybot',
           uaName: 'yacybot',
           uaUrl: 'http://yacy.net/bot.html',
           ...
           uaInfoUrl: '/list-of-ua/bot-detail?bot=yacybot' } },
     '12658': 
      { userAgent: 'Mozilla/5.0 (compatible; 008/0.85; http://www.80legs.com/webcrawler.html) Gecko/2008032620',
        metadata: 
         { uaFamily: '008',
           uaName: '008/0.85',
           uaUrl: 'http://www.80legs.com/webcrawler.html',
           ...
           uaInfoUrl: '/list-of-ua/bot-detail?bot=008' } },
     '12663': 
      { userAgent: 'yacybot (freeworld/global; i386 Linux 3.12-1-686-pae; java 1.7.0_21; Europe/fr) http://yacy.net/bot.html',
        metadata: 
         { uaFamily: 'yacybot',
           uaName: 'yacybot',
           uaUrl: 'http://yacy.net/bot.html',
           ...
           uaInfoUrl: '/list-of-ua/bot-detail?bot=yacybot' } },
     '12704': 
      { userAgent: 'PercolateCrawler/4 (ops@percolate.com)',
        metadata: 
         { uaFamily: 'PercolateCrawler',
           uaName: 'PercolateCrawler/4',
           uaUrl: '',
           uaCompany: 'Percolate Industries, Inc.',
           uaCompanyUrl: 'http://www.percolate.com/',
           uaIcon: 'bot.png',
           uaInfoUrl: '/list-of-ua/bot-detail?bot=PercolateCrawler' } },
     '12748': 
      { userAgent: 'TinEye-bot/0.02 (see http://www.tineye.com/crawler.html)',
        metadata: 
         { uaFamily: 'TinEye',
           uaName: 'TinEye-bot/0.02',
           uaUrl: 'http://tineye.com/crawler.html',
           uaCompany: 'Idée Inc.',
           uaCompanyUrl: 'http://ideeinc.com/',
           uaIcon: 'bot_TinEye.png',
           uaInfoUrl: '/list-of-ua/bot-detail?bot=TinEye' } },
     '12763': 
      { userAgent: 'Leikibot/1.0 (+http://www.leiki.com)',
        metadata: 
         { uaFamily: 'Leikibot',
           uaName: 'Leikibot/1.0',
           uaUrl: '',
           uaCompany: 'Leiki Ltd.',
           uaCompanyUrl: 'http://www.leiki.com/',
           uaIcon: 'bot.png',
           uaInfoUrl: '/list-of-ua/bot-detail?bot=Leikibot' } },
     '12779': 
      { userAgent: 'Mozilla/5.0 (iPhone; CPU iPhone OS 6_0 like Mac OS X) AppleWebKit/536.26 (KHTML, like Gecko) Version/6.0 Mobile/10A5376e Safari/8536.25 (compatible; Googlebot/2.1; +http://www.google.com/bot.html)',
        metadata: 
         { uaFamily: 'Googlebot',
           ...
           uaInfoUrl: '/list-of-ua/bot-detail?bot=Googlebot' } },
     '12780': 
      { userAgent: 'Mozilla/5.0 (compatible; musobot/1.0; info@muso.com; +http://www.muso.com)',
        metadata: 
         { uaFamily: 'musobot',
           uaName: 'musobot/1.0',
           uaUrl: '',
           uaCompany: 'MUSO TNT Ltd.',
           uaCompanyUrl: 'http://www.muso.com/',
           uaIcon: 'bot.png',
           uaInfoUrl: '/list-of-ua/bot-detail?bot=musobot' } },
     '12788': 
      { userAgent: 'Mozilla/5.0 (compatible; IstellaBot/1.18.81 +http://www.tiscali.it/)',
        metadata: 
         { uaFamily: 'IstellaBot',
           uaName: 'IstellaBot/1.18.81',
           uaUrl: '',
           uaCompany: 'Tiscali Italia S.p.a',
           uaCompanyUrl: 'http://www.tiscali.it/',
           uaIcon: 'bot.png',
           uaInfoUrl: '/list-of-ua/bot-detail?bot=IstellaBot' } },
     '12796': 
      { userAgent: 'Mozilla/5.0 (Nekstbot; http://www.ipipan.waw.pl/nekst/nekstbot/)',
        metadata: 
         { uaFamily: 'nekstbot',
           uaName: 'nekstbot',
           uaUrl: 'http://www.ipipan.waw.pl/nekst/nekstbot/',
           ...
           uaInfoUrl: '/list-of-ua/bot-detail?bot=nekstbot' } },
     '12817': 
      { userAgent: 'webinatorbot 1.1; +http://www.webinator.de',
        metadata: 
         { uaFamily: 'webinatorbot',
           uaName: 'webinatorbot 1.1',
           uaUrl: '',
           uaCompany: 'HighSignal UG',
           uaCompanyUrl: 'http://www.highsignal.de/',
           uaIcon: 'bot.png',
      ...
      { userAgent: 'Mozilla/5.0 (compatible; SpiderLing (a SPIDER for LINGustic research); +http://nlp.fi.muni.cz/projects/biwec/)',
        metadata: 
         { uaFamily: 'SpiderLing',
           ...
           uaInfoUrl: '/list-of-ua/bot-detail?bot=SpiderLing' } },
     '12857': 
      { userAgent: 'Mozilla/5.0 (compatible; LoadTimeBot/0.9; +http://www.loadtime.net/bot.html)',
        metadata: 
         { uaFamily: 'LoadTimeBot',
           uaName: 'LoadTimeBot/0.9',
           uaUrl: 'http://www.loadtime.net/bot.html',
           uaCompany: 'Loadtime',
           uaCompanyUrl: 'http://www.loadtime.net/',
           uaIcon: 'bot.png',
      ...
      { userAgent: 'CCBot/2.0 (http://commoncrawl.org/faq/)',
        metadata: 
         { uaFamily: 'CCBot',
           ...
           uaInfoUrl: '/list-of-ua/bot-detail?bot=CCBot' } },
     '12924': 
      { userAgent: 'yacybot (freeworld/global; amd64 Windows Server 2008 6.0; java 1.7.0_25; Europe/en) http://yacy.net/bot.html',
        metadata: 
         { uaFamily: 'yacybot',
           uaName: 'yacybot',
           uaUrl: 'http://yacy.net/bot.html',
      ...
      { userAgent: 'Mozilla/5.0 (compatible; spbot/4.0.9; +http://OpenLinkProfiler.org/bot )',
        metadata: 
         { uaFamily: 'spbot',
           ...
           uaInfoUrl: '/list-of-ua/bot-detail?bot=spbot' } },
     '12977': 
      { userAgent: 'Mozilla/5.0 (compatible; SecurityResearch.bot; +http://besome1.info/securityresearchbot.html)',
        metadata: 
         { uaFamily: 'SecurityResearchBot',
           uaName: 'SecurityResearchBot',
           uaUrl: 'http://besome1.info/securityresearchbot.html',
           uaCompany: 'SecurityResearchBot Team',
           uaCompanyUrl: '',
           uaIcon: 'bot.png',
           uaInfoUrl: '/list-of-ua/bot-detail?bot=SecurityResearchBot' } },
     '12985': 
      { userAgent: 'Googlebot (gocrawl v0.4)',
        metadata: 
         { uaFamily: 'gocrawl',
           uaName: 'gocrawl v0.4',
           uaUrl: 'https://github.com/PuerkitoBio/gocrawl',
           uaCompany: 'Martin Angers',
           uaCompanyUrl: 'http://0value.com/',
           uaIcon: 'bot.png',
           uaInfoUrl: '/list-of-ua/bot-detail?bot=gocrawl' } },
     '12989': 
      { userAgent: 'seegnifybot/1.0.0 (http://www.seegnify.com/bot)',
        metadata: 
         { uaFamily: 'seegnifybot',
           uaName: 'seegnifybot/1.0.0',
           uaUrl: 'http://www.seegnify.com/bot',
           uaCompany: 'Seegnify',
           uaCompanyUrl: 'http://www.seegnify.com/',
           uaIcon: 'bot.png',
           uaInfoUrl: '/list-of-ua/bot-detail?bot=seegnifybot' } },
     '13005': 
      { userAgent: 'Mozilla/5.0 (compatible; ExaleadCloudView/5;)',
        metadata: 
         { uaFamily: 'Exabot',
           uaName: 'ExaleadCloudview/5',
           uaUrl: 'http://www.exalead.com/search/webmasterguide',
           uaCompany: 'Dassault Systèmes',
           uaCompanyUrl: 'http://www.3ds.com/',
           uaIcon: 'bot_Exabot.png',
           uaInfoUrl: '/list-of-ua/bot-detail?bot=Exabot' } },
     '13099': 
      { userAgent: 'CorporateNewsSearchEngine/Nutch-1.7 (http://pibs.co/news-search-engine)',
        metadata: 
         { uaFamily: 'Company News Search engine',
           uaName: 'Company News Search engine',
           uaUrl: 'http://pibs.co/news-search-engine',
           uaCompany: 'PIBS Labc, Inc.',
           uaCompanyUrl: 'http://pibs.co/',
           uaIcon: 'bot.png',
           uaInfoUrl: '/list-of-ua/bot-detail?bot=Company News Search engine' } },
     '13101': 
      { userAgent: 'Mozilla/5.0 (compatible; Arachnophilia/1.0; +http://arachnys.com/)',
        metadata: 
         { uaFamily: 'Arachnophilia',
           uaName: 'Arachnophilia/1.0',
           uaUrl: '',
           uaCompany: 'Arachnys Information Services Ltd',
           uaCompanyUrl: 'http://www.arachnys.com/',
           uaIcon: 'bot.png',
           uaInfoUrl: '/list-of-ua/bot-detail?bot=Arachnophilia' } },
     '13111': 
      { userAgent: 'Urlstat (http://bit.ly/1dJuuzs)',
        metadata: 
         { uaFamily: 'Seobility',
           uaName: 'Seobility Urlstat',
           uaUrl: 'http://www.seobility.net/sites/bot.html',
           uaCompany: 'GF Consulting UG',
           uaCompanyUrl: 'http://gfconsulting.info/',
           uaIcon: 'bot.png',
           uaInfoUrl: '/list-of-ua/bot-detail?bot=Seobility' } },
     '13136': 
      { userAgent: 'Seobility (SEO-Check; http://bit.ly/1dJuuzs)',
        metadata: 
         { uaFamily: 'Seobility',
           uaName: 'Seobility SEO-Check',
           uaUrl: 'http://www.seobility.net/sites/bot.html',
           uaCompany: 'GF Consulting UG',
           uaCompanyUrl: 'http://gfconsulting.info/',
           uaIcon: 'bot.png',
           uaInfoUrl: '/list-of-ua/bot-detail?bot=Seobility' } },
     '13137': 
      { userAgent: 'KrOWLer/0.1.0, matentzn at cs dot man dot ac dot uk',
        metadata: 
         { uaFamily: 'KrOWLer',
           uaName: 'KrOWLer/0.1.0',
           uaUrl: '',
           uaCompany: 'Nico Matentzoglu',
           uaCompanyUrl: 'http://nico.matentzoglu.net/',
           uaIcon: 'bot.png',
           uaInfoUrl: '/list-of-ua/bot-detail?bot=KrOWLer' } },
     '13144': 
      { userAgent: 'SklikBot/2.0 (sklik@firma.seznam.cz;+http://napoveda.sklik.cz/)',
        metadata: 
         { uaFamily: 'SeznamBot',
           uaName: 'SklikBot/2.0',
           uaUrl: 'http://www.mapy.cz/cz/seznambot.html',
     ...
     '13148': 
      { userAgent: 'Mozilla/5.0 (compatible; Twingly Recon; twingly.com)',
        metadata: 
         { uaFamily: 'Twingly Recon',
           uaName: 'Twingly Recon',
           uaUrl: '',
           uaCompany: 'Twingly AB',
           uaCompanyUrl: 'http://www.twingly.com/',
           uaIcon: 'bot.png',
           uaInfoUrl: '/list-of-ua/bot-detail?bot=Twingly Recon' } },
     '13157': 
      { userAgent: 'Iframely/0.6.0 (+http://iframely.com/;)',
        metadata: 
         { uaFamily: 'Iframely',
           uaName: 'Iframely/0.6.0',
           uaUrl: '',
           uaCompany: 'Itteco Software Corp.',
           uaCompanyUrl: 'http://itteco.com/',
           uaIcon: 'bot.png',
           uaInfoUrl: '/list-of-ua/bot-detail?bot=Iframely' } },
     '13167': 
      { userAgent: 'Mozilla/5.0 (compatible; linkdexbot/2.0; +http://www.linkdex.com/bots/)',
        metadata: 
         { uaFamily: 'linkdexbot',
           ...
           uaInfoUrl: '/list-of-ua/bot-detail?bot=linkdexbot' } },
     '13172': 
      { userAgent: 'eCommerceBot (http://www.ehandel.se/botinfo.html)',
        metadata: 
         { uaFamily: 'eCommerceBot',
           uaName: 'eCommerceBot',
           uaUrl: 'http://www.ehandel.se/botinfo.html',
           uaCompany: 'EHANDEL SE AB',
           uaCompanyUrl: 'http://www.ehandel.se/',
           uaIcon: 'bot.png',
           uaInfoUrl: '/list-of-ua/bot-detail?bot=eCommerceBot' } },
     '13178': 
      { userAgent: 'MetaGeneratorCrawler/1.3.4 (www.metagenerator.info)',
        metadata: 
         { uaFamily: 'MetaGeneratorCrawler',
           uaName: 'MetaGeneratorCrawler/1.3.4',
           uaUrl: 'http://www.metagenerator.info/Crawler.html',
           uaCompany: 'Jan Bogutzki',
           uaCompanyUrl: 'http://jan.bogutzki.de/',
           uaIcon: 'bot.png',
           uaInfoUrl: '/list-of-ua/bot-detail?bot=MetaGeneratorCrawler' } },
     '13179': 
      { userAgent: 'MetaGeneratorCrawler/1.3.2 (www.metagenerator.info)',
        metadata: 
         { uaFamily: 'MetaGeneratorCrawler',
           uaName: 'MetaGeneratorCrawler/1.3.2',
           uaUrl: 'http://www.metagenerator.info/Crawler.html',
           uaCompany: 'Jan Bogutzki',
           uaCompanyUrl: 'http://jan.bogutzki.de/',
           uaIcon: 'bot.png',
           uaInfoUrl: '/list-of-ua/bot-detail?bot=MetaGeneratorCrawler' } },
     '13182': 
      { userAgent: 'Mozilla/5.0 (compatible; BLEXBotTest/1.0; +http://webmeup.com/crawler.html)',
        metadata: 
         { uaFamily: 'BLEXBot',
           uaName: 'BLEXBotTest/1.0',
           uaUrl: 'http://webmeup-crawler.com/',
           uaCompany: 'WebMeUp',
           uaCompanyUrl: 'http://webmeup.com/',
           uaIcon: 'bot.png',
           uaInfoUrl: '/list-of-ua/bot-detail?bot=BLEXBot' } },
     '13183': 
      { userAgent: 'Symfony Spider (http://symfony.com/spider)',
        metadata: 
         { uaFamily: 'Symfony Spider',
           uaName: 'Symfony Spider',
           uaUrl: 'http://symfony.com/spider',
           uaCompany: 'SensioLabs',
           uaCompanyUrl: 'http://sensiolabs.com/',
           uaIcon: 'bot.png',
           uaInfoUrl: '/list-of-ua/bot-detail?bot=Symfony Spider' } },
     '13200': 
      ...
      { userAgent: 'GarlikCrawler/1.2 (http://garlik.com/, crawler@garlik.com)',
        metadata: 
         { uaFamily: 'GarlikCrawler',
           ...
           uaInfoUrl: '/list-of-ua/bot-detail?bot=GarlikCrawler' } },
     '13228': 
      { userAgent: 'Mozilla/5.0 (compatible; SemrushBot/0.97~bl; +http://www.semrush.com/bot.html)',
        metadata: 
         { uaFamily: 'SemrushBot',
           uaName: 'SemrushBot/0.97',
           uaUrl: 'http://www.semrush.com/bot.html',
     ...
     '13230': 
      { userAgent: 'Mozilla/5.0 (compatible; EveryoneSocialBot/1.0; support@everyonesocial.com http://everyonesocial.com/)',
        metadata: 
         { uaFamily: 'EveryoneSocialBot',
           uaName: 'EveryoneSocialBot/1.0',
           uaUrl: '',
           uaCompany: 'Gravit, Inc.',
           uaCompanyUrl: 'http://everyonesocial.com/',
           uaIcon: 'bot.png',
           uaInfoUrl: '/list-of-ua/bot-detail?bot=EveryoneSocialBot' } },
     '13231': 
      { userAgent: 'WeSEE:Ads/PageBot (http://www.wesee.com/bot/)',
        metadata: 
         { uaFamily: 'WeSEE',
           uaName: 'WeSEE:Ads/PageBot',
           uaUrl: 'http://www.wesee.com/bot/',
           uaCompany: 'WeSEE Ltd',
           uaCompanyUrl: 'http://www.wesee.com/',
           uaIcon: 'bot.png',
           uaInfoUrl: '/list-of-ua/bot-detail?bot=WeSEE' } },
     '13271': 
      { userAgent: 'yacybot (webportal/global; x86_64 Mac OS X 10.9.2; java 1.6.0_65; Europe/de) http://yacy.net/bot.html',
        metadata: 
         { uaFamily: 'yacybot',
           uaName: 'yacybot',
           uaUrl: 'http://yacy.net/bot.html',
           ...
           uaInfoUrl: '/list-of-ua/bot-detail?bot=yacybot' } },
     '13275': 
      { userAgent: 'Mozilla/5.0 (compatible; Genieo/1.0 http://www.genieo.com/webfilter.html) AppEngine-Google; (+http://code.google.com/appengine; appid: s~natmacdevice)',
        metadata: 
         { uaFamily: 'Genieo Web filter',
           uaName: 'Genieo/1.0',
           uaUrl: 'http://www.genieo.com/webfilter.html',
           ...
           uaInfoUrl: '/list-of-ua/bot-detail?bot=Genieo Web filter' } },
     '13281': 
      { userAgent: 'seebot/1.0.0 (http://www.seegnify.com/bot)',
        metadata: 
         { uaFamily: 'seegnifybot',
           uaName: 'seebot/1.0.0',
           uaUrl: 'http://www.seegnify.com/bot',
      ...
      { userAgent: 'Mozilla/5.0 (compatible; MJ12bot/v1.4.5; http://www.majestic12.co.uk/bot.php?+)',
        metadata: 
         { uaFamily: 'MJ12bot',
           ...
           uaInfoUrl: '/list-of-ua/bot-detail?bot=MJ12bot' } },
     '13354': 
      { userAgent: 'yacybot (freeworld/global; amd64 Linux 3.12.15-gentoo; java 1.7.0_55; Europe/en) http://yacy.net/bot.html',
        metadata: 
         { uaFamily: 'yacybot',
           uaName: 'yacybot',
           uaUrl: 'http://yacy.net/bot.html',
      ...
      { userAgent: 'Mozilla/5.0 (compatible; spbot/4.1.0; +http://OpenLinkProfiler.org/bot )',
        metadata: 
         { uaFamily: 'spbot',
           ...
           uaInfoUrl: '/list-of-ua/bot-detail?bot=spbot' } },
     '13365': 
      { userAgent: 'MetaGeneratorCrawler/1.3.9 (www.metagenerator.info)',
        metadata: 
         { uaFamily: 'MetaGeneratorCrawler',
           uaName: 'MetaGeneratorCrawler/1.3.9',
           uaUrl: 'http://www.metagenerator.info/Crawler.html',
           uaCompany: 'Jan Bogutzki',
           uaCompanyUrl: 'http://jan.bogutzki.de/',
           uaIcon: 'bot.png',
      ...
      { userAgent: 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10.9; rv:28.0) Gecko/20100101 Firefox/28.0 (FlipboardProxy/1.1; +http://flipboard.com/browserproxy)',
        metadata: 
         { uaFamily: 'FlipboardProxy',
           ...
           uaInfoUrl: '/list-of-ua/bot-detail?bot=FlipboardProxy' } },
     '13405': 
      { userAgent: 'Pinterest/0.1 +http://pinterest.com/',
        metadata: 
         { uaFamily: 'Pinterest',
           uaName: 'Pinterest/0.1',
           uaUrl: '',
           uaCompany: 'Pinterest, Inc.',
           uaCompanyUrl: 'http://www.pinterest.com/',
           uaIcon: 'bot.png',
           uaInfoUrl: '/list-of-ua/bot-detail?bot=Pinterest' } },
     '13413': 
      { userAgent: 'WeSEE:Ads/PictureBot (http://www.wesee.com/bot/)',
        metadata: 
         { uaFamily: 'WeSEE',
           uaName: 'WeSEE:Ads/PictureBot',
           uaUrl: 'http://www.wesee.com/bot/',
           uaCompany: 'WeSEE Ltd',
           uaCompanyUrl: 'http://www.wesee.com/',
           uaIcon: 'bot.png',
           uaInfoUrl: '/list-of-ua/bot-detail?bot=WeSEE' } },
     '13439': 
      { userAgent: 'Mozilla/5.0 (compatible; WebCorp/5.0; +http://www.webcorp.org.uk)',
        metadata: 
         { uaFamily: 'WebCorp',
           uaName: 'WebCorp/5.0',
           uaUrl: '',
           uaCompany: 'RDUES',
           uaCompanyUrl: 'http://rdues.bcu.ac.uk/',
           uaIcon: 'bot.png',
           uaInfoUrl: '/list-of-ua/bot-detail?bot=WebCorp' } },
     '13440': 
      { userAgent: 'x28-job-bot; +http://x28.ch/bot.html',
        metadata: 
         { uaFamily: 'x28-job-bot',
           uaName: 'x28-job-bot',
           uaUrl: 'http://x28.ch/bot.html',
           uaCompany: 'x28 AG',
           uaCompanyUrl: 'http://www.x28.ch/',
           uaIcon: 'bot.png',
           uaInfoUrl: '/list-of-ua/bot-detail?bot=x28-job-bot' } },
     '13476': 
      { userAgent: 'Mozilla/5.0 (compatible; Alexabot/1.0; +http://www.alexa.com/help/certifyscan; certifyscan@alexa.com)',
        metadata: 
         { uaFamily: 'Alexabot',
           uaName: 'Alexabot/1.0',
           uaUrl: 'http://www.alexa.com/help/certifyscan',
           uaCompany: 'Alexa Internet, Inc.',
           uaCompanyUrl: 'http://www.alexa.com/',
           uaIcon: 'bot.png',
           uaInfoUrl: '/list-of-ua/bot-detail?bot=Alexabot' } },
     '13514': 
      { userAgent: 'Mozilla/4.0 (compatible;  Vagabondo/4.0/EU; http://webagent.wise-guys.nl/)',
        metadata: 
         { uaFamily: 'Vagabondo',
           uaName: 'Vagabondo/4.0/EU',
           uaUrl: 'http://webagent.wise-guys.nl/',
           uaCompany: 'WiseGuys Internet BV',
           uaCompanyUrl: 'http://www.wise-guys.nl/',
           uaIcon: 'bot.png',
           uaInfoUrl: '/list-of-ua/bot-detail?bot=Vagabondo' } },
     '13564': 
      { userAgent: 'AskQuickly v2 (http://askquickly.org/)',
        metadata: 
         { uaFamily: 'AskQuickly',
           uaName: 'AskQuickly v2',
           uaUrl: '',
           uaCompany: 'Jayde Online, Inc.',
           uaCompanyUrl: 'http://www.jaydeonlineinc.com/',
           uaIcon: 'bot.png',
           uaInfoUrl: '/list-of-ua/bot-detail?bot=AskQuickly' } },
     '13576': 
      { userAgent: 'Mozilla/5.0 (compatible; STINGbot/1.0; +http://136.186.231.16)',
        metadata: 
         { uaFamily: 'STINGbot',
           uaName: 'STINGbot/1.0',
           uaUrl: 'http://136.186.231.16/',
           uaCompany: 'Centre for Advanced Internet Architectures',
           uaCompanyUrl: 'http://caia.swin.edu.au/',
           uaIcon: 'bot.png',
           uaInfoUrl: '/list-of-ua/bot-detail?bot=STINGbot' } },
     '13587': 
      { userAgent: 'Mozilla/5.0 (compatible; 007ac9 Crawler; http://crawler.007ac9.net/)',
        metadata: 
         { uaFamily: '007AC9',
           uaName: '007AC9',
           uaUrl: 'http://crawler.007ac9.net/',
           uaCompany: 'SISTRIX GmbH',
           uaCompanyUrl: 'http://www.sistrix.de/',
           uaIcon: 'bot.png',
           uaInfoUrl: '/list-of-ua/bot-detail?bot=007AC9' } },
     '13618': 
      { userAgent: 'yacybot (freeworld/global; x86 Windows XP 5.1; java 1.7.0_55; Asia/en) http://yacy.net/bot.html',
        metadata: 
         { uaFamily: 'yacybot',
           uaName: 'yacybot',
           uaUrl: 'http://yacy.net/bot.html',
           ...
           uaInfoUrl: '/list-of-ua/bot-detail?bot=yacybot' } },
     '13650': 
      { userAgent: 'Mozilla/5.0 (compatible; idmarch Automatic.beta/1.2; +http://www.idmarch.org/bot.html)',
        metadata: 
         { uaFamily: 'idmarch',
           uaName: 'idmarch Automatic.beta/1.2',
           uaUrl: 'http://www.idmarch.org/bot.html',
           uaCompany: 'International Digital Media Archive',
           uaCompanyUrl: 'http://www.idmarch.org/',
           uaIcon: 'bot.png',
           uaInfoUrl: '/list-of-ua/bot-detail?bot=idmarch' } },
     '13695': 
      { userAgent: 'yacybot (freeworld/global; amd64 Windows 7 6.1; java 1.7.0_60; Europe/de) http://yacy.net/bot.html',
        metadata: 
         { uaFamily: 'yacybot',
           uaName: 'yacybot',
           uaUrl: 'http://yacy.net/bot.html',
      ...
      { userAgent: 'yacybot (/global; amd64 Linux 3.14-0.bpo.1-amd64; java 1.7.0_55; Europe/de) http://yacy.net/bot.html',
        metadata: 
         { uaFamily: 'yacybot',
           ...
           uaInfoUrl: '/list-of-ua/bot-detail?bot=yacybot' } },
     '13719': 
      { userAgent: 'HubSpot Crawler 1.0 http://www.hubspot.com/',
        metadata: 
         { uaFamily: 'HubSpot Crawler',
           uaName: 'HubSpot Crawler 1.0',
           uaUrl: '',
           uaCompany: 'HubSpot, Inc.',
           uaCompanyUrl: 'http://www.hubspot.com/',
           uaIcon: 'bot.png',
           uaInfoUrl: '/list-of-ua/bot-detail?bot=HubSpot Crawler' } },
     '13743': 
      { userAgent: 'sosoimagespider+(+http://help.soso.com/soso-image-spider.htm)',
        metadata: 
         { uaFamily: 'Sosospider',
           uaName: 'Sosoimagespider',
           uaUrl: 'http://help.soso.com/soso-image-spider.htm',
           uaCompany: 'Tencent, Inc.',
           uaCompanyUrl: 'http://www.tencent.com/',
           uaIcon: 'bot_soso.png',
           uaInfoUrl: '/list-of-ua/bot-detail?bot=Sosospider' } },
     '13747': 
      { userAgent: 'Mozilla/5.0 (compatible; dlcbot/0.1; +http://www.drlinkcheck.com/)',
        metadata: 
         { uaFamily: 'dlcbot',
           uaName: 'dlcbot/0.1',
           uaUrl: '',
           uaCompany: 'Wulfsoft - Andreas Wulf',
           uaCompanyUrl: 'http://www.wulfsoft.com/',
           uaIcon: 'bot.png',
           uaInfoUrl: '/list-of-ua/bot-detail?bot=dlcbot' } },
     '13786': 
      { userAgent: 'yacybot (freeworld/global; amd64 Linux 3.2.0-4-amd64; java 1.7.0_55; Europe/de) http://yacy.net/bot.html',
        metadata: 
         { uaFamily: 'yacybot',
           uaName: 'yacybot',
           uaUrl: 'http://yacy.net/bot.html',
           ...
           uaInfoUrl: '/list-of-ua/bot-detail?bot=yacybot' } },
     '13791': 
      { userAgent: 'yacybot (freeworld/global; x86 Windows 7 6.1; java 1.7.0_25; Europe/de) http://yacy.net/bot.html',
        metadata: 
         { uaFamily: 'yacybot',
           uaName: 'yacybot',
           uaUrl: 'http://yacy.net/bot.html',
           ...
           uaInfoUrl: '/list-of-ua/bot-detail?bot=yacybot' } },
     '13809': 
      { userAgent: 'Mozilla/5.0 (compatible; LA1; +http://www.zeerch.com/bot.php)',
        metadata: 
         { uaFamily: 'ZeerchBot',
           uaName: 'ZeerchBot LA1',
           uaUrl: 'http://www.zeerch.com/bot.php',
           uaCompany: 'Zeerch Inc.',
           uaCompanyUrl: 'http://www.zeerch.com/',
           uaIcon: 'bot.png',
           uaInfoUrl: '/list-of-ua/bot-detail?bot=ZeerchBot' } },
     '13837': 
      { userAgent: 'SCFCrawler/Nutch-1.8 (Image Crawler for StolenCameraFinder.com; http://www.stolencamerafinder.com/; crawler@stolencamerafinder.com)',
        metadata: 
         { uaFamily: 'SCFCrawler',
           uaName: 'SCFCrawler',
           uaUrl: '',
           uaCompany: 'Matt Burns Ltd',
           uaCompanyUrl: 'http://www.mattburns.co.uk/',
           uaIcon: 'bot.png',
           uaInfoUrl: '/list-of-ua/bot-detail?bot=SCFCrawler' } },
     '13879': 
      { userAgent: 'Mozilla/5.0 (compatible; websays; +http://wiki.github.com/bixo/bixo/bixocrawler; bixo-dev@yahoogroups.com)',
        metadata: 
         { uaFamily: 'bixocrawler',
           uaName: 'bixocrawler',
           uaUrl: 'http://wiki.github.com/bixo/bixo/bixocrawler',
     ...
     '13893': 
      { userAgent: 'Mozilla/5.0 (compatible; SputnikBot/2.3; +http://corp.sputnik.ru/webmaster)',
        metadata: 
         { uaFamily: 'SputnikBot',
           uaName: 'SputnikBot/2.3',
           uaUrl: 'http://corp.sputnik.ru/webmaster',
           uaCompany: 'OJSC Rostelecom',
           uaCompanyUrl: 'http://www.rostelecom.ru/en/about/info/',
           uaIcon: 'bot_SputnikBot.png',
           uaInfoUrl: '/list-of-ua/bot-detail?bot=SputnikBot' } },
     '13895': 
      { userAgent: 'pr-cy.ru Screenshot Bot',
        metadata: 
         { uaFamily: 'pr-cy.ru Screenshot Bot',
           uaName: 'pr-cy.ru Screenshot Bot',
           uaUrl: '',
           uaCompany: 'Mirafox',
           uaCompanyUrl: 'http://mirafox.com/',
           uaIcon: 'bot.png',
           uaInfoUrl: '/list-of-ua/bot-detail?bot=pr-cy.ru Screenshot Bot' } },
     '13901': 
      { userAgent: 'Mozilla/5.0 (compatible; Linux x86_64; Mail.RU_Bot/Robots/2.0; +http://go.mail.ru/help/robots)',
        metadata: 
         { uaFamily: 'Mail.Ru bot',
           uaName: 'Mail.RU_Bot/Robots/2.0',
           uaUrl: 'http://go.mail.ru/help/robots',
           uaCompany: 'Mail.Ru Group',
           uaCompanyUrl: 'http://corp.mail.ru/',
           uaIcon: 'bot.png',
     ...
     '13940': 
      { userAgent: 'Mozilla/5.0 (seoanalyzer; compatible; bingbot/2.0; +http://www.bing.com/bingbot.htm)',
        metadata: 
         { uaFamily: 'bingbot',
           uaName: 'bingbot/2.0 seoanalyser',
           uaUrl: 'http://www.bing.com/webmaster/help/which-crawlers-does-bing-use-8c184ec0',
           uaCompany: 'Microsoft Corporation',
           uaCompanyUrl: 'http://www.microsoft.com/',
           uaIcon: 'bot_msnbot.png',
           uaInfoUrl: '/list-of-ua/bot-detail?bot=bingbot' } },
     '13956': 
      { userAgent: 'XoviBot/1.0',
        metadata: 
         { uaFamily: 'XoviBot',
           uaName: 'XoviBot/1.0',
           uaUrl: 'http://www.xovibot.net/',
           uaCompany: 'Xovi GmbH',
           uaCompanyUrl: 'http://www.xovi.de/',
           uaIcon: 'bot_xovibot.png',
           uaInfoUrl: '/list-of-ua/bot-detail?bot=XoviBot' } },
     '13971': 
      { userAgent: 'Mozilla/5.0 (compatible; XoviBot/2.0; +http://www.xovibot.net/)',
        metadata: 
         { uaFamily: 'XoviBot',
           ...
           uaInfoUrl: '/list-of-ua/bot-detail?bot=XoviBot' } },
     '13978': 
      { userAgent: 'Mozilla/5.0 (compatible; LA2; +http://www.zeerch.com/zeerch2/bot.php)',
        metadata: 
         { uaFamily: 'ZeerchBot',
           uaName: 'ZeerchBot LA2',
           uaUrl: 'http://www.zeerch.com/bot.php',
           uaCompany: 'Zeerch Inc.',
           uaCompanyUrl: 'http://www.zeerch.com/',
           uaIcon: 'bot.png',
           uaInfoUrl: '/list-of-ua/bot-detail?bot=ZeerchBot' } },
     '13991': 
      { userAgent: 'Mozilla/5.0 (compatible; MSIE or Firefox mutant; not on Windows server;) Daumoa/4.0',
        metadata: 
         { uaFamily: 'Daumoa',
           uaName: 'Daumoa/4.0',
           uaUrl: 'http://tab.search.daum.net/aboutWebSearch_en.html',
           ...
           uaInfoUrl: '/list-of-ua/bot-detail?bot=Daumoa' } },
     '14010': 
      { userAgent: 'SurcentroBot',
        metadata: 
         { uaFamily: 'SurcentroBot',
           uaName: 'SurcentroBot',
           uaUrl: '',
           uaCompany: 'SurCentro',
           uaCompanyUrl: 'http://www.surcentro.com/',
           uaIcon: 'bot.png',
           uaInfoUrl: '/list-of-ua/bot-detail?bot=SurcentroBot' } },
     '14012': 
      { userAgent: 'Mozilla/5.0 (compatible; hypestat/1.0; +http://www.hypestat.com/bot)',
        metadata: 
         { uaFamily: 'HypeStat',
           uaName: 'HypeStat/1.0',
           uaUrl: 'http://www.hypestat.com/bot',
           uaCompany: 'hypestat.com',
           uaCompanyUrl: 'http://www.hypestat.com/',
           uaIcon: 'bot.png',
           uaInfoUrl: '/list-of-ua/bot-detail?bot=HypeStat' } },
     '14023': 
      { userAgent: 'MixBot (+http://t.co/GSRLLKex24)',
        metadata: 
         { uaFamily: 'MixBot',
           uaName: 'MixBot',
           uaUrl: '',
           uaCompany: 'MIXDATA',
           uaCompanyUrl: 'http://www.mixdata.com/',
           uaIcon: 'bot.png',
           uaInfoUrl: '/list-of-ua/bot-detail?bot=MixBot' } },
     '14029': 
      { userAgent: 'ImplisenseBot 1.0',
        metadata: 
         { uaFamily: 'ImplisenseBot',
           uaName: 'ImplisenseBot 1.0',
           uaUrl: '',
           uaCompany: 'Implisense GmbH',
           uaCompanyUrl: 'http://www.implisense.com/',
           uaIcon: 'bot.png',
           uaInfoUrl: '/list-of-ua/bot-detail?bot=ImplisenseBot' } },
     '14062': 
      { userAgent: 'stq_bot (+http://www.searchteq.de)',
        metadata: 
         { uaFamily: 'stq_bot',
           uaName: 'stq_bot',
           uaUrl: '',
           uaCompany: 'SEARCHTEQ GmbH',
           uaCompanyUrl: 'http://www.searchteq.de/',
           uaIcon: 'bot.png',
           uaInfoUrl: '/list-of-ua/bot-detail?bot=stq_bot' } },
     order: 
      [ '13587',
        '1633',
        '1871',
   ...
   { '1': 
     ...
     '653': 
      { regexp: /^Mozilla[\s\S]*AppleWebKit[\s\S]*Chrome[\s\S]*Perk\/([0-9\.]+)/i,
        browserId: '502' },
     '654': 
      { regexp: /^Mozilla[\s\S]*AppleWebKit[\s\S]*otter\/([0-9a-z\-\.]+) Safari/i,
        browserId: '503' },
     '655': 
  ...
  osReg: 
   { '1': { regexp: /windows nt 5\.1/i, osId: '1' },
     ...
     '214': { regexp: /iPad[\s\S]*OS 8_[0-9_]+/i, osId: '143' },
     '215': { regexp: /iPhone OS 8_[0-9_]+/i, osId: '143' },
   ...
   { '1': { regexp: /iPad[\s\S]*OS[\s\S]*like Mac OS X/i, deviceId: '4' },
     ...
     '23': 
      { regexp: /^Mozilla[\s\S]*Android[\s\S]*Sony Tablet P/i,
        deviceId: '4' },
     '24': 
      { regexp: /^Mozilla[\s\S]*Android[\s\S]*(SGP311|SGP321)/i,
        deviceId: '4' },
     '25': 
      { regexp: /^Mozilla[\s\S]*Gecko[\s\S]*Firefox[\s\S]*Kylo\/([0-9\.]+)$/i,
        deviceId: '6' },
     ...
     '54': 
      { regexp: /^Mozilla[\s\S]*Android[\s\S]*(IdeaTab|SmartTabII7|Lenovo A1|K1 Build\/K1|Lenovo B8000-H|Lenovo B6000-H)/i,
        deviceId: '4' },
     '55': 
     ...
     '89': 
      { regexp: /^Mozilla[\s\S]*Android[\s\S]*ARCHOS GAMEPAD[\s\S]*AppleWebKit/i,
        deviceId: '5' },
     '90': 
      { regexp: /^Mozilla[\s\S]*Android[\s\S]*ME173X/i,
        deviceId: '4' },
     '91': 
     ...
     '97': 
      { regexp: /^Mozilla[\s\S]*Android[\s\S]*PMP5570C/i,
        deviceId: '4' },
     '98': 
     ...
     '103': 
      { regexp: /^Mozilla[\s\S]*Android[\s\S]*(TAB[\s\S]*Xenta|TAB[\s\S]*Luna|TAB[\s\S]*Build\/GRI40|TAB[\s\S]*Build\/IML74K|TAB[\s\S]*Build\/IML74K)/i,
        deviceId: '4' },
     '104': 
      { regexp: /^Mozilla[\s\S]*Android[\s\S]*(A701|A210|A211|A100|A101|b1-720|B1-A71|B1-710|B1-711|a510s)/i,
        deviceId: '4' },
     '105': 
     ...
     '109': 
      { regexp: /^Mozilla[\s\S]*Android[\s\S]*(PMID701C|PMID701i|PMID705|PMID706|PMID70DC|PMID70C|PMID720|PTAB1050|ptab750|PTAB7200|ptab4300|pmid920)/i,
        deviceId: '4' },
     '110': 
      { regexp: /^Mozilla[\s\S]*Android[\s\S]*(K00C|K00U|K00Z|K00L|K00F)/i,
        deviceId: '4' },
     '111': 
